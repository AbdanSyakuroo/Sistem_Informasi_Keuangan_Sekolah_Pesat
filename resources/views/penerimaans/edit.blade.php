...
<head>
    ...
    <title>Edit Penerimaan Harian</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-xl mx-auto bg-white bg-opacity-95 backdrop-blur-sm shadow-2xl rounded-3xl p-10 transform transition-all duration-300">
        <!-- Header Section -->
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-blue-800 tracking-tight">Edit Penerimaan</h1>
            <p class="text-gray-600 mt-2">Perbarui informasi penerimaan dana yang sudah ada.</p>
        </div>
        ...
        <form action="{{ route('penerimaans.update', $penerimaan->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    id="uraian" 
                    name="uraian" 
                    value="{{ old('uraian', $penerimaan->uraian) }}" 
                    placeholder="Contoh: Penerimaan dana donasi"
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    id="nominal" 
                    name="nominal" 
                    value="{{ old('nominal', $penerimaan->nominal) }}" 
