...
<head>
    ...
    <title>Tambah Penerimaan Harian</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-xl mx-auto bg-white bg-opacity-95 backdrop-blur-sm shadow-2xl rounded-3xl p-10 transform transition-all duration-300">
        <!-- Header Section -->
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-blue-800 tracking-tight">Tambah Penerimaan</h1>
            <p class="text-gray-600 mt-2">Formulir untuk mencatat penerimaan dana baru.</p>
        </div>
