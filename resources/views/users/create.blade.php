...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-lg mx-auto bg-white bg-opacity-95 backdrop-blur-sm shadow-2xl rounded-3xl p-10 transform transition-all hover:scale-100 duration-300">
        ...
        <!-- Header Section -->
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-blue-800 tracking-tight">Tambah User Baru</h1>
            <p class="text-gray-600 mt-2">Formulir untuk menambahkan data pengguna baru ke sistem.</p>
        </div>
