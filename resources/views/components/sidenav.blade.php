...
<head>
    ...
    <style>
        ...
        .sidebar-nav-wrapper .nav-item.active>a {
            ...
            /* warna untuk parent dropdown aktif */
        }

        .dropdown-nav a {
            display: block;
            /* bikin dia full 1 baris */
            width: 100%;
            /* pastikan lebar penuh */
            padding: 8px 16px;
            /* atur padding biar rapi */
            box-sizing: border-box;
            /* biar padding ga bikin melar */
        }
    ...
    <aside class="sidebar-nav-wrapper">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                {{-- Penerimaan --}}
                <li class="nav-item">
                    <a href="{{ url('penerimaans') }}" class="{{ Request::is('penerimaans') ? 'active' : '' }}">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                @php
                    $sumberdana_active =
                        Request::is('sumber_dana*') ||
                        Request::is('penerimaan-sumber-dana') ||
                        Request::is('laporan_realisasi');
                @endphp
                <li class="nav-item nav-item-has-children {{ $sumberdana_active ? 'active' : '' }}">
                    <a href="#0" class="{{ $sumberdana_active ? '' : 'collapsed' }}" data-bs-toggle="collapse"
                        data-bs-target="#ddmenu_sumberdana" aria-expanded="{{ $sumberdana_active ? 'true' : 'false' }}">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <ul id="ddmenu_sumberdana" class="collapse dropdown-nav {{ $sumberdana_active ? 'show' : '' }}">
                        <li>
                            <a href="{{ url('sumber_dana') }}"
                                class="{{ Request::is('sumber_dana') ? 'active' : '' }}">
                                Jenis
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('penerimaan-sumber-dana') }}"
                                class="{{ Request::is('penerimaan-sumber-dana') ? 'active' : '' }}">
                                Data Penerimaan
                            </a>
                        </li>
                        <li>
                ...
                {{-- Kegiatan --}}
                <li class="nav-item">
                    <a href="{{ url('kegiatans') }}" class="{{ Request::is('kegiatans') ? 'active' : '' }}">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                {{-- Pengeluaran --}}
                <li class="nav-item">
                    <a href="{{ url('pengeluarans') }}" class="{{ Request::is('pengeluarans') ? 'active' : '' }}">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="nav-item nav-item-has-children {{ $laporan_active ? 'active' : '' }}">
                    <a href="#0" class="{{ $laporan_active ? '' : 'collapsed' }}" data-bs-toggle="collapse"
                        data-bs-target="#ddmenu_2" aria-expanded="{{ $laporan_active ? 'true' : 'false' }}">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="flex items-center">
                    <form method="POST" action="{{ route('logout') }}" class="w-50 ml-20">
                        @csrf
                        <button type="submit"
                            class="btn btn-danger w-100 rounded-md d-flex align-items-center justify-content-center py-2 px-4 shadow-sm">
                            Logout
                        </button>
                    </form>
                </li>
