...
<head>
    ...
    <style>
        ...
        /* Pastikan ikon non-aktif (semua) di menu utama adalah ABU-ABU */
        .sidebar-nav .nav-item:not(.active) a .icon {
        ...
        /* Pastikan ikon non-aktif di sub-menu adalah ABU-ABU */
        .dropdown-nav li a:not(.active) .icon {
            color: var(--sidebar-text-color);
        }
        ...
        .sidebar-nav .main-nav .nav-item:nth-child(1) {
            --item-index: 1;
        }

        .sidebar-nav .main-nav .nav-item:nth-child(2) {
            --item-index: 2;
        }

        .sidebar-nav .main-nav .nav-item:nth-child(3) {
            --item-index: 3;
        }

        .sidebar-nav .main-nav .nav-item:nth-child(4) {
            --item-index: 4;
        }

        .sidebar-nav .main-nav .nav-item:nth-child(5) {
            --item-index: 5;
        }

        .sidebar-nav .main-nav .nav-item:nth-child(6) {
            --item-index: 6;
        }
    </style>
            ...
            <ul class="main-nav">
                ...
                <li class="nav-item nav-item-has-children {{ $sumberdana_active ? 'active' : '' }}">
                    ...
                    <ul id="ddmenu_sumberdana" class="collapse dropdown-nav {{ $sumberdana_active ? 'show' : '' }}">
                        <li><a href="{{ url('sumber_dana') }}"
                                class="{{ Request::is('sumber_dana') ? 'active' : '' }}">Jenis Sumber</a></li>
                        <li><a href="{{ url('penerimaan-sumber-dana') }}"
                                class="{{ Request::is('penerimaan-sumber-dana') ? 'active' : '' }}">Penerimaan Dana</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item nav-item-has-children {{ $laporan_active ? 'active' : '' }}">
                    ...
                    <ul id="ddmenu_laporan" class="collapse dropdown-nav {{ $laporan_active ? 'show' : '' }}">
                        ...
                        <li><a href="{{ url('laporan') }}"
                                class="{{ Request::is('laporan') ? 'active' : '' }}">Keseluruhan</a></li>
                    </ul>
                </li>
            </ul>
